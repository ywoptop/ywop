// Globale Variable für Audio, um Autoplay-Probleme zu umgehen
...
function initMedia() {
  ...
  backgroundVideo.muted = true; // Sicherstellen, dass Video gemutet ist

  // Musik wird erst nach Klick auf Startbildschirm abgespielt
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Benutzerdefinierter Cursor für Desktop und Mobile
  const cursor = document.querySelector('.custom-cursor');
  const isTouchDevice = window.matchMedia("(pointer: coarse)").matches;

  if (isTouchDevice) {
    document.body.classList.add('touch-device');
    // Cursor für Touch-Geräte anzeigen
    ...
    document.addEventListener('touchend', () => {
      cursor.style.display = 'none'; // Cursor ausblenden, wenn Touch endet
    });
  } else {
    // Cursor für Desktop
  ...
  // Startbildschirm Typewriter-Effekt
  ...
  // Blinkender Cursor für Startbildschirm
  setInterval(() => {
    startCursorVisible = !startCursorVisible;
    startText.textContent = startTextContent + (startCursorVisible ? '|' : ' ');
  }, 500);

  // Profilview-Zähler Logik
  ...
  // Typewriter-Effekt für Bio mit Loop
  const bioMessages = [
    "i do scripting gfx vfx",
    "\"Everything brazy everything brazy\""
  ];
  let bioText = '';
  let bioIndex = 0;
  ...
  // Verbesserte Lautstärkeregler-Interaktion
  ...
  transparencySlider.addEventListener('input', () => {
    ...
    if (opacity == 0) {
      ...
      // Sicherstellen, dass Kinder-Elemente sichtbar und interaktiv bleiben
  ...
  // Musik-, Video- und Overlay-Switching-Funktion mit Transition und Farbwechsel für den Strahl
  ...
  // Glitch-Effekt bei Hover über Profilbild
  ...
  // Korrigierte Drehanimation nach Klick auf Profilbild
  ...
  // Results-Button Logik (Hacker Theme)
  ...
  // Start Typewriter-Effekt für Startbildschirm
  typeWriterStart();
});